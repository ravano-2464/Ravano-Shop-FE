...
const translations = {
  en: {
    ...
    history: {
      ...
      subtitle: 'View all transactions and products you have purchased',
      totalTransactions: 'Total Transactions',
      totalSpent: 'Total Spent',
      productsBought: 'Products Bought',
      noTransactions: 'No Transactions Yet',
      noTransactionsDesc: 'You have not made any purchases. Start shopping now!',
      loading: 'Loading purchase history...',
      total: 'Total',
      qty: 'Qty',
      fetchError: 'Failed to load purchase history',
    },
    notFound: {
      badge: '⚠️ Error 404',
      titleLine1: 'Lost in',
  ...
  id: {
    ...
    auth: {
      ...
      registerSubtitle: 'Mulai perjalanan belanja Anda',
    ...
    history: {
      ...
      subtitle: 'Lihat semua transaksi dan produk yang telah Anda beli',
      totalTransactions: 'Total Transaksi',
      totalSpent: 'Total Pengeluaran',
      productsBought: 'Produk Dibeli',
      noTransactions: 'Belum Ada Transaksi',
      noTransactionsDesc: 'Anda belum melakukan pembelian apapun. Mulai belanja sekarang!',
      loading: 'Memuat riwayat pembelian...',
      total: 'Total',
      qty: 'Qty',
      fetchError: 'Gagal memuat riwayat pembelian',
    },
    notFound: {
      badge: '⚠️ Galat 404',
